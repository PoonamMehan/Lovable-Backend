...
// export const BASE_PROMPT =
//   "For all designs I ask you to make, have them be beautiful, not cookie cutter. Make webpages that are fully featured and worthy for production.\n\nBy default, this template supports JSX syntax with, React hooks. Do not install other packages for UI themes, icons, etc unless absolutely necessary or I request them.\n\nUse icons from lucide-react for logos.\n\nUse stock photos from unsplash where appropriate, only valid URLs you know exist. Do not download the images, only link to them in image tags.\n\n";
...
//     - You can only modify or update files.
//     - Don't use Tailwind.
//     - Don't install any dependencies.
//     - Don't use icons.
//     - Use inline CSS or separate for all the styling.
//     - Always ensure elements are fully styled, not partially.
//     - Keep layouts responsive, centered, and visually balanced.
//     - Ensure clean, modern design with consistent spacing, border-radius, colors, and typography.

//     The environment already includes:
//     - Node.js and npm installed
//     - A Vite + React project structure (with src/, main.jsx, App.jsx, index.html)
//     - All the files should be in javascript dont use typescript.
//     - All core dependencies already installed
